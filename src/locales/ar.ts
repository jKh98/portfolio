export const ar = {
  ...
  // Home
  HOME_MESSAGE: "أنا مهندس برامج متكاملة للويب والجوّال.",

  // Overview
  OVERVIEW_HEADING: "ماذا أفعل",
  OVERVIEW_TITLE_1: "الويب والجوال",
  OVERVIEW_TITLE_2: "البرامج الخلفية",
  OVERVIEW_TITLE_3: "الحلول الرقمية",
  OVERVIEW_DESC_1:
    "متخصص في تصميم وتطوير الويب سريع الاستجابة وتطبيقات الأجهزة المحمولة",
  OVERVIEW_DESC_2: "لدي خبرة كبيرة في تصميم وتنفيذ خدمات آمنة وقابلة للتطوير",
  OVERVIEW_DESC_3: "أعمل على تطوير أحدث الحلول الرقمية لمعالجة المشاكل الحديثة",
  ...
  ASU: "جامعة ولاية أريزونا",
  ASU_DATE: "08/2021 - 06/2023",
  ASU_DEGREE: "ماجستير في هندسة البرمجيات",
  AUB: "الجامعة الأمريكية في بيروت",
  AUB_DATE: "08/2016 - 06/2020",
  AUB_DEGREE: "بكالوريوس هندسة في هندسة الكمبيوتر والاتصالات",
